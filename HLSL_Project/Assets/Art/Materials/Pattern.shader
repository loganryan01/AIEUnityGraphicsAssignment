Shader "Unlit/Pattern"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            {
                // The diffuse lighting, the normal do-producted with the light's direction
                ...
                // Finally we will be using the step() function to choose between the hghlight, base and the shadow color
